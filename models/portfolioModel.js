...
const tradeSchema = new mongoose.Schema({
    ticker: { type: String, uppercase: true, required: true, trim: true, enum: ['TCS', 'WIPRO', 'GODREJIND'] },
...
const securitySchema = new mongoose.Schema({
    ticker: { type: String, required: true, trim: true, uppercase: true, enum: ['TCS', 'WIPRO', 'GODREJIND'] },
